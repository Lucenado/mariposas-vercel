...
function CatalogItem() {
  ...
  useEffect(() => {
    ...
    const fetchMain = () => {
      return fetch(`https://mariposas-vercel-api.vercel.app/MainMoths/mainMoths_get/${id}`, { 
            method: 'get', 
            headers: {
    ...
    const fetchSyns = () => {
      return fetch(`https://mariposas-vercel-api.vercel.app/MainMoths/mainMoths_getSyns/${id}`, { 
            method: 'get', 
            headers: {
                'my_token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2VtYWlsIjoicGVkcm9sdWNlbmFkb0BnbWFpbC5jb20iLCJpYXQiOjE2ODQ4NzYwODJ9.qt-zB7qLuhUY1xc2XwjQNdNBHc2zR7B3SnTD_z_htcg'
            } 
    ...
    const fetchImgs = () => {
      return fetch(`https://mariposas-vercel-api.vercel.app/MothImgs/imageMoths_getSomeId/${id}`, { 
        method: 'get', 
        headers: {
            'my_token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2VtYWlsIjoicGVkcm9sdWNlbmFkb0BnbWFpbC5jb20iLCJpYXQiOjE2ODQ4NzYwODJ9.qt-zB7qLuhUY1xc2XwjQNdNBHc2zR7B3SnTD_z_htcg'
        } 
    ...
    const fetchColls = () => {
      return fetch(`https://mariposas-vercel-api.vercel.app/MothCollection/collectionMoths_filter_main/${id}`, { 
        method: 'get', 
        headers: {
            'my_token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2VtYWlsIjoicGVkcm9sdWNlbmFkb0BnbWFpbC5jb20iLCJpYXQiOjE2ODQ4NzYwODJ9.qt-zB7qLuhUY1xc2XwjQNdNBHc2zR7B3SnTD_z_htcg'
        } 
    ...
    const fetchRefs = () => {
      return fetch(`https://mariposas-vercel-api.vercel.app/MothRefs/refMoths_get/${id}`, { 
        method: 'get', 
        headers: {
            'my_token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2VtYWlsIjoicGVkcm9sdWNlbmFkb0BnbWFpbC5jb20iLCJpYXQiOjE2ODQ4NzYwODJ9.qt-zB7qLuhUY1xc2XwjQNdNBHc2zR7B3SnTD_z_htcg'
        } 
